...
#define NR_DOMAIN_WATCHDOG_TIMERS 2
    ...
    /* jinho added for service type store */
#define SCHED_SVC_UNKNOWN           -1
#define SCHED_SVC_ONLINE_ACTIVE     0
#define SCHED_SVC_ONLINE_INACTIVE   1
#define SCHED_SVC_OFFLINE_ACTIVE    2   /* default */
#define SCHED_SVC_OFFLINE_INACTIVE  3
#define SCHED_SVC_NUM               4
#define SCHED_SVC_DEFAULT           SCHED_SVC_OFFLINE_ACTIVE
    uint32_t service_type;

#define SCHED_SVC_TYPE_TIME_MAX     10000000 /* 10 sec*/
    int st_time;
};
